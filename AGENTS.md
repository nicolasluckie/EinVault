...
`CHANGELOG.md` is auto-generated by git-cliff. Run `scripts/version-bump.sh X.Y.Z` to generate it when preparing a release. Do **not** edit it manually — changes will be overwritten.
